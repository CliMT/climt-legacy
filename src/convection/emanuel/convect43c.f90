...
!***************************************************************************
        ...
        SUBROUTINE CONVECT &
         (T,   Q,    QS,     U,    V,      TRA,    P,    PH,&
          ...
          FV,  FTRA, PRECIP, WD,   TPRIME, QPRIME, CBMF, OUTCAPE )&
...
!
      ...
      real(c_double) :: A2, AD, AFAC, AHM, AHMAX, AHMIN, ALPHA, ALT, ANUM
      real(c_double) :: ALTEM, ALV, ALVNEW, AM, AMDE, AMP1, ASIJ, AWAT, B6
      real(c_double) :: BETA, BF2, BSUM, BY, BYP, C6, CAPE, CAPEM, CBMFOLD
      real(c_double) :: CHI, CL, COEFF, COEFFR, COEFFS, CPINV, CPV, CPD, CPVMCL, CU
      real(c_double) :: CWAT, DAMP, DAMPS, DBO, DBOSUM, DEFRAC, DEI, DELM
      real(c_double) :: DELP, DELT0, DELTI, DENOM, DHDP, DPHINV, DPINV
      real(c_double) :: DTMA, DTMAX, DTMIN, DTPBL, ELACRIT, ELCRIT, ENTP, ENTS, EPMAX
      real(c_double) :: EPS, EPSI, FAC, FQOLD, FRAC, FTOLD, FTRAOLD, FUOLD, FVOLD
      real(c_double) :: G, GINV, OMTRAIN, OMTSNOW, PLCL, QNEW, QP1, QSM, QSTM, QTI
      real(c_double) :: RAT, RD, RDCP, REVAP, RH, RM, ROWL, RV, SCRIT, SIGD, SIGS, SIGT
      real(c_double) :: SJMIN, SJMAX, SMID, SMIN, STEMP, SUM1, TC, TCA, THBAR, TLCRIT
      real(c_double) :: TNEW, TRAAV, TVAPLCL, TVPPLCL, TVX, TVY, UAV, UM, VAV, VM, WDTRAIN, X

      integer(c_int) :: I, ICB, IHMIN, INB, INB1, IPBL, J, JC, K
      integer(c_int) :: JIT, JN, NK, JTT, MINORIG
!
! -----------------------------------------------------------------------
!
!   ***                     Specify Switches                         ***
...
!
        ...
        real(c_double) :: LV0
        real(c_double) :: CPD, CPV, CL, RV, RD, CPVMCL, EPS, EPSI
